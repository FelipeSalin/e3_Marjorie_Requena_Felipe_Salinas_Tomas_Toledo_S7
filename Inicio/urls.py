...
from Inicio.views import listar_categorias, listar_tipoProductos, listar_marcaProductos, listar_productos, lista_producto, listar_productosMarca, listar_tipoUsuario, listar_usuarios, lista_usuario, listar_comunas, listar_regiones, lista_region, listar_direcciones, listar_direccionesregion, listar_ventas, listar_modelos, lista_modelo, listar_detalleporventa, listar_detalleporproducto, lista_detalle, noticias_juegos #mis_datos
...
urlpatterns = [
    ...
    #No funciona path('api/', include('rest_api.urls')),
    ...
    path('api/Productos', lista_producto, name='lista_Producto'),
    ...
    path('api/usuarios', lista_usuario, name='lista_usuario'),
    ...
    path('api/regiones', lista_region, name='lista_region'),
    ...
    path('api/modelos>', lista_modelo, name='lista_modelo'),
    ...
    path('api/detalles', lista_detalle, name='lista_detalle'),
    #path('api/inicio', (view), name='...')
